...
ORG_TYPES = [
    ...
    {"id": 6, "code": "Общ-е",  "name_ru": "Общежития",                                  "description": "Общежития при ТиППО и ВиПО"},
    {"id": 7, "code": "ГОНС",   "name_ru": "ГОНС Келешек",                               "description": "Государственная образовательная накопительная система"},
]
