...
export default function DopoPage() {
  ...
  const { data: stats }       = useApi<EduLevelStats>('/edu-level/dopo/stats?period_year=2026');
  const { data: sectorStats } = useApi<EduLevelSectorStats>('/edu-level/dopo/sector-stats?period_year=2026');
